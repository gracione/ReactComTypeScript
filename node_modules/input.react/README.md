...
<div class="face-one-intro">
    <div class="face-one-intro-title">input.react</div>
    <h2 class="face-one-intro-desc">
        Input & Textarea
    </h2>
    <div class="face-one-intro-tool">
        <a href="https://onface.github.io/input.react" class="face-one-intro-btn face-one-intro-btn--primary mr-online-hide" >在线文档</a>
        <!-- MARKRUN-HTML
            <a href="./doc/intro.md" class="face-one-intro-btn face-one-intro-btn--primary">指引</a>
            <a href="http://github.com/onface/input.react" class="face-one-intro-btn">GITHUB</a>
        -->
    </div>
</div>
        ...
        <tr>
            <td align="center" >
                <div class="face-one-feature-item">
                    ...
                    <br />
                    <div class="face-one-feature-item-label">自定义界面</div>
                    <div class="face-one-feature-item-desc">提供配置好的 less 文件便于二次开发</div>
                </div>
            </td>
            <td align="center" >
                <div class="face-one-feature-item">
            ...
            <td align="center" >
                <div class="face-one-feature-item">
                    ...
                    <br />
                    <div class="face-one-feature-item-label">placeholder={node}</div>
                    <div class="face-one-feature-item-desc">提示文字支持 HTML, React Element</div>
                </div>
            </td>
        </tr>
    </table>
